  ...
  return (
    <div className='fixed top-0 z-50 w-full flex justify-between items-center p-4'>
      ...
      <div className='flex gap-3'>
        ...
        <Link href="/privacy" className='px-4 py-2 text-white/80 hover:text-white flex items-center justify-center font-medium transition-colors'>Privacy Policy</Link>
        <Link href="/about" className='px-4 py-2 text-white/80 hover:text-white flex items-center justify-center font-medium transition-colors'>About</Link>
